...
set -e
echo "删除备份"
ssh ubuntu@52.87.178.171 "rm -rf /home/ubuntu/backend-testing/source/back-admin/back-admin.jar.bak"
# 1. back remote file
echo "备份远程文件"
...
echo "上传文件"
# 2. upload local file
scp -l 1000000 -o ConnectTimeout=60000 ./ruoyi-admin/target/back-admin.jar ubuntu@52.87.178.171:/home/ubuntu/backend-testing/source/back-admin
echo "启动远程服务"
# 3. 关闭远程java进程
