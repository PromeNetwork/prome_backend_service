...
<script>
import { listCoupon, getCoupon, delCoupon, addCoupon, updateCoupon } from "@/api/biz/coupon";
...
export default {
  ...
  methods: {
    ...
    handleDelete(row) {
      ...
      this.$modal.confirm('是否确认删除coupon编号为"' + ids + '"的数据项？').then(function() {
    ...
    /** 导出按钮操作 */
    handleExport() {
      this.download('biz/coupon/export', {
        ...this.queryParams
